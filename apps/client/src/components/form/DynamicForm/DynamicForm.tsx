...
export interface DynamicFormProps<T extends FormDataType> {
  className?: string;
...
export const DynamicForm = <T extends FormDataType>({ className, fields, schema, onSubmit }: DynamicFormProps<T>) => {
