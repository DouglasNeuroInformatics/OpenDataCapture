...
export class SubjectsAPI {
  ...
  static async getInstrumentRecords(instrumentTitle: string, subjectId: string) {
    const response = await axios.get(`/api/instruments/records?instrument=${instrumentTitle}&subject=${subjectId}`);
