      ...
      <Dialog.Content>
        ...
        <Dialog.Description>
          {t({
            ...
            es: 'Tiene cambios sin guardar. ¿Seguro que desea salir? Se perderán sus cambios. Seleccione "No" y haga clic en la X de la esquina superior derecha para conservarlos.',
