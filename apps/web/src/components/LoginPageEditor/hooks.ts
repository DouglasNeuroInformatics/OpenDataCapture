  ...
  const updateSetupStateMutation = useUpdateSetupStateMutation({
    successNotification: {
      message: t({
        ...
        es: 'La página de inicio de sesión se ha actualizado.',
        fr: 'La page de connexion a été mise à jour.'
      }),
      title: t({ en: 'Success', es: 'Operación realizada', fr: 'Succès' })
    }
  });
      ...
      .catch((error: unknown) => {
        ...
        addNotification({
          message: t({
            ...
            es: 'No se pudo leer el archivo seleccionado como imagen.',
