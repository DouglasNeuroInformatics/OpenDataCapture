      ...
      <Card.Header>
        <Card.Title>
          {t({
            ...
            es: 'Activar la página de inicio de sesión personalizada',
        ...
        <Card.Description>
          {t({
            ...
            es: 'Cuando está desactivada, se muestra la página de inicio de sesión clásica de Open Data Capture.',
