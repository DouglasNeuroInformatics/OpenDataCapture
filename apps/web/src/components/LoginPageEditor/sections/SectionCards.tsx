    ...
    <Card key="logo">
      <SectionHeader
        description={t({
          ...
          es: 'Suba una imagen de hasta 2 MB (SVG, PNG, JPEG, WebP) o enlace a una. Las imágenes PNG y JPEG se convierten a WebP para ahorrar espacio.',
            ...
            <div className={cn('flex flex-col gap-3', form.logoSource !== 'upload' && 'opacity-60')}>
              <div className="flex items-center gap-2">
                ...
                <Label className="cursor-pointer font-medium" htmlFor="logoSource-upload">
                  {t({ en: 'Uploaded image', es: 'Imagen subida', fr: 'Image téléversée' })}
                </Label>
              </div>
              <div className="pl-6">
                <input
                  ...
                  >
                    {form.customLogoSrc ? (
                      ...
                      <React.Fragment>
                        ...
                        <span className="text-muted-foreground text-xs">
                          {t({ en: 'Click to upload', es: 'Haga clic para subir', fr: 'Cliquez pour téléverser' })}
                        </span>
                      </React.Fragment>
                    )}
                  </button>
              ...
              {isCustomSizeInvalid && (
                <p className="text-destructive text-xs">
                  {t({
                    ...
                    es: 'Introduzca al menos un valor positivo (1–5000).',
          ...
          {form.resourceLinks.length === 0 && (
            <p className="text-muted-foreground text-sm">
              {t({
                ...
                es: 'Aún no hay enlaces. Agregue uno para empezar.',
                ...
                {hrefInvalid && (
                  <p className="text-destructive text-xs">
                    {t({
                      ...
                      es: 'La URL debe empezar por http:// o https:// e incluir un dominio (p. ej. example.com).',
