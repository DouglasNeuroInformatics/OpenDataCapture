    ...
    return [
      {
        content: (
          <p>
            {t({
              ...
              es: 'Este tutorial ofrece una breve introducción al uso de Open Data Capture.',
            ...
            <span className="font-bold">
              {t({
                ...
                es: 'Complételo antes de hacer cualquier pregunta sobre la plataforma.',
            ...
            {t({
              ...
              es: 'Una vez completado el tutorial, esta ventana dejará de aparecer al iniciar sesión en Open Data Capture.',
        ...
        title: t({
          ...
          es: 'Le damos la bienvenida a Open Data Capture 👋',
        ...
        content: (
          <p>
            {t({
              ...
              es: 'En esta página puede consultar y exportar los datos que ha recopilado su grupo.',
        ...
        content: (
          <p>
            {t({
              ...
              es: 'Aquí puede buscar sujetos en la base de datos. Para empezar, escriba en la barra de búsqueda para encontrar los identificadores de sujeto que coincidan',
        ...
        content: (
          <p>
            {t({
              ...
              es: 'Aquí puede buscar sujetos en la base de datos. Para empezar, haga clic en el botón Buscar sujeto y aparecerá una ventana donde podrá introducir la consulta.',
      ...
      },
      {
        content: t({
          ...
          es: 'Puede iniciar una sesión con un identificador personalizado o dejar que el sistema cree uno a partir de los datos personales del sujeto. Si elige la opción de generación automática, el identificador se crea en su navegador, de modo que el nombre y el apellido del sujeto nunca se envían a nuestro servidor.',
      ...
      },
      {
        content: t({
          ...
          es: 'Puede usar el identificador que prefiera; el nombre de su grupo se añadirá automáticamente para garantizar que sea único.',
      ...
      },
      {
        content: t({
          ...
          es: 'Puede elegir una sesión en persona (la opción predeterminada) o una sesión retrospectiva para introducir datos recopilados previamente con otro sistema.',
      ...
      },
      {
        content: t({
          ...
          es: 'Aquí puede ver la sesión que está en curso.',
      ...
      },
      {
        content: t({
          ...
          es: 'En esta página puede consultar los datos del sujeto de la sesión actual. Para acceder a los datos de otros sujetos, use el botón de búsqueda en la página Centro de datos.',
      ...
      },
      {
        content: t({
          ...
          es: 'Aquí puede consultar los registros que este sujeto ha completado para un instrumento determinado.',
