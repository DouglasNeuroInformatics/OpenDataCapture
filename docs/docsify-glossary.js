...
this['@stijn-dejongh/docsify-glossary'].js = (function (exports) {
  ...
  function configFromYaml(configurationYaml) {
    ...
    return new GlossaryConfigurationBuilder()
      .withTermHeading(
        (_configurationYaml$te = configurationYaml.terminologyHeading) !== null && _configurationYaml$te !== void 0
          ? _configurationYaml$te
          : DEFAULT_TERM_HEADING
      )
      .withGlossaryLocation(
        (_configurationYaml$gl = configurationYaml.glossaryLocation) !== null && _configurationYaml$gl !== void 0
          ? _configurationYaml$gl
          : DEFAULT_GLOSSARY_FILE_NAME
      )
      .withDebugEnabled(
        (_configurationYaml$de = configurationYaml.debug) !== null && _configurationYaml$de !== void 0
          ? _configurationYaml$de
          : false
      )
      .withTitleTermReplacement(
        (_configurationYaml$re = configurationYaml.replaceTitleTerms) !== null && _configurationYaml$re !== void 0
          ? _configurationYaml$re
          : true
      )
      .build();
  }
  ...
  function install(hook, _vm) {
    ...
    if (configuration.debug) {
      console.log(
        'Using config options: '.concat(configuration.glossaryLocation, ', ').concat(configuration.terminologyHeading)
      );
    }
