...
- `internal`
  - Information about the instrument that is used internally to generate a unique identifier. As such, the combination of which should not conflict with any existing instruments in the database.
- `internal.name`
