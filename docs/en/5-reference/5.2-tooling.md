...
The entire codebase is written in Typescript, and each package has a `tsconfig.json` file that extends the `tsconfig.json` file located in the root of the monorepo. T
