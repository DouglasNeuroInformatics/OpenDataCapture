...
export const emptyBilingualForm: InstrumentLibraryItem;
export const emptyUnilingualForm: InstrumentLibraryItem;
export const genericFormInstrument: InstrumentLibraryItem;
