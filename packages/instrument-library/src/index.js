...
export { default as emptyBilingualForm } from './forms/empty-bilingual-form.instrument?instrument';
export { default as emptyUnilingualForm } from './forms/empty-unilingual-form.instrument?instrument';
