function extractLanguageProperty(element) {
    ...
    this.#languageAttributeObserver = new MutationObserver((mutations) => {
      mutations.forEach((mutation) => {
        if (mutation.attributeName === 'lang') {
          this.#resolvedLanguage = extractLanguageProperty(mutation.target);
...
export const i18n = typeof window !== 'undefined' ? new I18N() : {};
