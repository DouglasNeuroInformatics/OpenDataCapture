...
/** FormInstrumentStaticField */
{
  ...
  /** Value Types */
  {
    ...
    expectTypeOf<
      FormInstrumentStaticField<InstrumentLanguage, FormTypes.RequiredFieldValue<FormTypes.NumberRecordFieldValue>>
    >().toEqualTypeOf<FormInstrumentNumberRecordField>();
    expectTypeOf<
      FormInstrumentStaticField<InstrumentLanguage, FormTypes.RequiredFieldValue<FormTypes.RecordArrayFieldValue>>
...
/** FormInstrumentUnknownField */
{
  ...
  /** Value Types */
  {
    ...
    /** Record Array */
    {
      expectTypeOf<FormInstrumentUnknownField<{ _: FormTypes.RecordArrayFieldValue }>['kind']>().toEqualTypeOf<
        'dynamic' | 'record-array'
      >();
      expectTypeOf<FormInstrumentUnknownField<{ _: FormTypes.RecordArrayFieldValue }>>().toEqualTypeOf<
        | FormInstrumentDynamicField<
    ...
    /** Number Record */
    {
      expectTypeOf<FormInstrumentUnknownField<{ _: FormTypes.NumberRecordFieldValue }>['kind']>().toEqualTypeOf<
        'dynamic' | 'number-record'
      >();
      expectTypeOf<FormInstrumentUnknownField<{ _: FormTypes.NumberRecordFieldValue }>>().toEqualTypeOf<
        | FormInstrumentDynamicField<
