...
| ----------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `packages/vite-plugin-runtime`                                                                                                | `generateMetadata` in `packages/runtime-meta/src/index.js` calls `readdir` on it → ENOENT while the Vite config is being resolved (the plugin factory awaits it) |
