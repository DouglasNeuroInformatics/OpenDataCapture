...
interface JQueryPromiseOperator<T, U> {
  (
    callback1: Array<JQueryPromiseCallback<T>> | JQueryPromiseCallback<T>,
    ...callbacksN: Array<Array<JQueryPromiseCallback<any>> | JQueryPromiseCallback<any>>
  ): JQueryPromise<U>;
}
...
interface JQueryStatic {
   ...
   */
  when<T>(...deferreds: Array<JQueryPromise<T> | T /* as JQueryDeferred<T> */>): JQueryPromise<T>;
}
