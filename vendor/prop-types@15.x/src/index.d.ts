...
export type ReactNodeLike = boolean | null | number | ReactElementLike | ReactNodeArray | string | undefined;
...
export interface Requireable<T> extends Validator<null | T | undefined> {
